...
export default function Loader({ onComplete }: LoaderProps) {
  ...
  return (
    <div
      className={`fixed inset-0 z-50 flex flex-col items-center justify-center bg-background transition-all duration-800 cubic-bezier(0.77, 0, 0.175, 1) ${
    ...
    >
      ...
      <div className="relative z-10 flex flex-col items-center max-w-md w-full px-6">
        ...
        {/* Agency Name */}
        <h1 className="mb-2 text-2xl font-bold tracking-[0.2em] text-foreground text-center">
          A&A
        </h1>
        ...
        <div className="w-full">
          ...
          <div className="h-[2px] w-full bg-glass-bg rounded-full overflow-hidden relative">
            <div
        ...
        <div className="mt-4 h-6 text-center">
          ...
          {progress >= 25 && progress < 60 && (
            <span className="text-[10px] tracking-wider text-muted animate-pulse">
