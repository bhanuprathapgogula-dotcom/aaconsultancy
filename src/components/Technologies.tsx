...
export default function Technologies() {
  ...
  const techStack: TechItem[] = [
    ...
    },
    {
      ...
      accent: "text-foreground border-glass-border group-hover:border-white/80",
    ...
    <section id="technologies" className="relative py-24 bg-transparent overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12 relative z-10">
        ...
        <div className="flex flex-col items-center text-center mb-16">
          ...
          <p className="text-sm md:text-base text-muted max-w-xl font-light leading-relaxed">
        ...
        <div className="relative h-[480px] w-full flex flex-col items-center justify-center select-none">
                ...
                return (
                  ...
                  >
                    ...
                    >
                      {/* FRONT FACE */}
                      <div
                        className={`absolute inset-0 glass-panel rounded-2xl p-6 border bg-gradient-to-b from-glass-bg to-transparent flex flex-col items-center justify-center text-center transition-all duration-300 hover:border-glass-border ${tech.accent}`}
                        style={{
                          backfaceVisibility: "hidden",
                      ...
                      >
                        ...
                        {/* Icon container */}
                        <div className="mb-4 p-4 rounded-full bg-glass-bg border border-glass-border group-hover:bg-glass-hover transition-all duration-300">
                          {tech.icon}
                        </div>
                      ...
                      {/* BACK FACE (Details) */}
                      <div
                        className="absolute inset-0 glass-panel rounded-2xl p-6 border border-glass-border bg-background/95 flex flex-col items-center justify-center text-center"
                        style={{
                          backfaceVisibility: "hidden",
                      ...
                      >
                        ...
                        {/* Description */}
                        <p className="text-[11px] md:text-xs text-muted font-light leading-relaxed mb-6">
                          {tech.desc}
                        </p>
                        ...
                        <button
                          ...
                          className="text-[10px] uppercase tracking-wider text-neon-purple font-semibold hover:text-foreground transition-colors cursor-pointer"
                        >
                          Close Details
                        </button>
                      </div>
          ...
          {activeTech !== null && (
            <button
              ...
              className="absolute bottom-0 flex items-center gap-2 px-4 py-2 rounded-full bg-glass-bg border border-glass-border text-[10px] font-bold uppercase tracking-wider text-foreground hover:bg-glass-hover hover:border-glass-border transition-all z-20 cursor-pointer"
            >
