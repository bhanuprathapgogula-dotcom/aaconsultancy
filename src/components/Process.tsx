            ...
            {steps.map((step, index) => {
              ...
              return (
                ...
                >
                  ...
                  <div className="absolute left-[29px] md:left-1/2 top-2 h-14 w-14 rounded-full bg-background border-2 border-glass-border flex items-center justify-center -translate-x-1/2 z-20 shadow-lg shadow-black group">
                  ...
                  <div className="w-full md:w-1/2 pl-16 md:pl-0 md:px-12 relative z-10">
                    <motion.div
                      ...
                      className="glass-panel glass-panel-hover rounded-2xl p-6 md:p-8 border border-glass-border bg-gradient-to-br from-glass-bg to-transparent hover:shadow-2xl flex flex-col items-start relative group"
                    >
                      {/* Step Number label */}
