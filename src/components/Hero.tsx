    ...
    >
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12 w-full grid grid-cols-1 lg:grid-cols-12 gap-12 items-center relative z-10 py-12">
        ...
        <div className="lg:col-span-7 flex flex-col items-start text-left">
          {/* Tagline Badge */}
          <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-glass-bg border border-glass-border mb-6 backdrop-blur-sm animate-pulse-slow">
          ...
          {/* Heading */}
          <h1 className="text-4xl md:text-6xl font-extrabold tracking-tight text-foreground mb-6 leading-[1.1] font-sans">
            Transforming
          ...
          {/* Subtitle */}
          <p className="text-base md:text-lg text-muted max-w-xl mb-10 leading-relaxed font-sans font-light">
          ...
          <div className="flex flex-col sm:flex-row gap-4 w-full sm:w-auto">
            ...
            <button
              ...
              className="flex items-center justify-center gap-2 rounded-full bg-glass-bg border border-glass-border px-8 py-4 text-sm font-semibold text-foreground uppercase tracking-wider hover:bg-glass-hover transition-all duration-300 w-full sm:w-auto"
            >
              Our Services
