      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12 relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-stretch">
            ...
            <div className="space-y-6">
              {contactInfo.map((info, idx) => (
                <a
                  ...
                  className="glass-panel glass-panel-hover rounded-2xl p-6 border border-white/5 bg-gradient-to-tr from-white/2 to-transparent flex gap-5 items-start block"
                >
                  ...
                  <div>
                    ...
                    <span className="block text-base font-semibold text-gray-300 group-hover:text-white transition-colors">
                      {info.value}
                    </span>
              ...
              <div className="flex gap-3">
                {socialLinks.map((social, index) => (
                  <a
                    ...
                    className="p-3 rounded-xl bg-white/5 border border-white/10 text-gray-400 hover:text-white hover:border-white/20 transition-all hover:scale-105"
          ...
          <div className="lg:col-span-7 flex flex-col gap-6">
            {/* Section Header */}
            <div className="glass-panel rounded-2xl p-6 border border-white/5 bg-gradient-to-tr from-white/2 to-transparent">
            ...
            {/* Employer Card */}
            <div className="glass-panel glass-panel-hover rounded-2xl p-8 border border-white/5 bg-gradient-to-tr from-white/2 to-transparent flex flex-col md:flex-row items-start md:items-center gap-6 justify-between group">
            ...
            <div className="glass-panel glass-panel-hover rounded-2xl p-8 border border-white/5 bg-gradient-to-tr from-white/2 to-transparent flex flex-col md:flex-row items-start md:items-center gap-6 justify-between group">
              ...
              <a
                href="https://docs.google.com/forms/d/1JitFcL02Htoc6qYA4ZIDRIy_ctV0Ub9BwK14aI9K3OA/viewform"
                target="_blank"
                rel="noopener noreferrer"
                className="glow-btn-blue relative shrink-0 inline-flex items-center justify-center gap-2 rounded-full bg-gradient-to-r from-neon-blue to-neon-purple px-6 py-3 text-xs font-semibold text-white uppercase tracking-wider cursor-pointer"
              >
