...
export default function TrustedBy() {
  ...
  const brandLogos = [
    {
      name: "Quantum",
      logo: (
        <svg className="h-6 w-auto text-muted group-hover:text-neon-cyan transition-colors" viewBox="0 0 120 30" fill="currentColor">
    ...
    },
    {
      name: "Nexus",
      logo: (
        <svg className="h-6 w-auto text-muted group-hover:text-neon-blue transition-colors" viewBox="0 0 100 30" fill="currentColor">
    ...
    },
    {
      name: "Aether",
      logo: (
        <svg className="h-6 w-auto text-muted group-hover:text-neon-purple transition-colors" viewBox="0 0 110 30" fill="currentColor">
    ...
    },
    {
      name: "Synthesis",
      logo: (
        <svg className="h-6 w-auto text-muted group-hover:text-neon-cyan transition-colors" viewBox="0 0 125 30" fill="currentColor">
    ...
    },
    {
      name: "Vertex",
      logo: (
        <svg className="h-6 w-auto text-muted group-hover:text-neon-blue transition-colors" viewBox="0 0 105 30" fill="currentColor">
    ...
    },
    {
      name: "Apex Labs",
      logo: (
        <svg className="h-6 w-auto text-muted group-hover:text-neon-purple transition-colors" viewBox="0 0 120 30" fill="currentColor">
  ...
  return (
    <section className="relative py-12 bg-transparent overflow-hidden border-y border-glass-border">
