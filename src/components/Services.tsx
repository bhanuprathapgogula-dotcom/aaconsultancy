        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {services.map((service) => (
            <motion.div
              ...
              className="group glass-panel rounded-2xl p-6 md:p-8 border border-glass-border bg-gradient-to-b from-glass-bg to-transparent hover:shadow-2xl hover:shadow-neon-blue/10 relative overflow-hidden flex flex-col justify-between min-h-[320px] cursor-pointer"
            >
              ...
              <div>
                ...
                <div className="flex justify-between items-center mb-6 relative z-10">
                  <div className="p-3.5 rounded-xl bg-glass-bg border border-glass-border group-hover:bg-glass-hover group-hover:border-glass-border transition-all duration-300">
                    {service.icon}
                  </div>
                  <button
                    onClick={() => handleScroll("#contact")}
                    className="p-1 rounded-full bg-transparent text-gray-500 group-hover:text-foreground group-hover:bg-glass-hover transition-all duration-300"
                  >
                ...
                {/* Service Details */}
                <h3 className="text-lg font-bold text-foreground mb-3 group-hover:text-neon-cyan transition-colors relative z-10">
                  {service.title}
                </h3>
                <p className="text-xs md:text-sm text-muted font-light leading-relaxed group-hover:text-muted transition-colors relative z-10">
                  {service.desc}
                </p>
              </div>
