...
export default function Footer() {
  ...
  return (
    <footer className="relative bg-transparent overflow-hidden pt-16 pb-12 border-t border-white/5">
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12 relative z-10">
          ...
          <div className="col-span-2 md:col-span-4 flex flex-col items-start gap-4">
            <a href="#home" onClick={(e) => handleScrollTo(e, "#home")} className="flex items-center gap-3 group">
              <div className="relative flex h-9 w-9 items-center justify-center rounded-lg bg-gradient-to-tr from-neon-blue to-neon-purple p-[1px]">
                <div className="flex h-full w-full items-center justify-center rounded-[7px] bg-[#03050f]">
              ...
              <div className="flex flex-col">
                <span className="text-xs font-bold tracking-[0.15em] text-white leading-none uppercase">
                  A&A
                </span>
        ...
        <div className="pt-8 border-t border-white/5 flex flex-col sm:flex-row items-center justify-between gap-6">
          ...
          <button
            ...
            className="p-3 rounded-xl bg-white/5 border border-white/10 text-gray-400 hover:text-white hover:border-white/20 transition-all flex items-center gap-2 text-xs font-bold uppercase tracking-wider group"
          >
            Scroll Top
